...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#0a0a16] border-t border-white/5 p-8 mt-auto z-40">
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-cyan-500 rounded flex items-center justify-center text-black font-black text-sm">A</div>
            <span className="font-bold text-lg tracking-tighter uppercase text-white">AITE Ecosystem</span>
          </div>
          <p className="text-xs text-gray-500 leading-relaxed max-w-xs">
            The next generation of high-frequency algorithmic trading powered by advanced neural architecture and emotional intelligence safeguards.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-xs text-gray-500">
            ...
            <li className="hover:text-white cursor-pointer transition-colors">Bot Ensambles</li>
        ...
        <div>
          <h4 className="text-[10px] font-black uppercase tracking-widest text-rose-500 mb-4">Protocol Status</h4>
          <div className="space-y-3">
             ...
             <p className="text-[10px] text-gray-600 leading-normal">
               AITE protocols are strictly for educational and automated analysis purposes. Trading involves risk of loss. Neural predictions are probabilistic.
             </p>
             <p className="text-[10px] text-gray-700 mt-2">© 2024 AITE NEURAL LABS. ALL RIGHTS RESERVED.</p>
          </div>
        </div>
      </div>
    </footer>
